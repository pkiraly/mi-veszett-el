...
df_full %>% 
  ...
  count(!is.na(x_letezo_peldanyok_szama) & x_letezo_peldanyok_szama > 0)
...
overview1$data = factor(overview1$data, levels = c('1885', '1971', '2024'))
estimation1$data = factor(estimation1$data, levels = c('1885', '1971', '2024'))
overview1$hipothetical = c(133, 162, 180)
overview1
...
ggsave("img/abundance/v03/3-fazisu-becsles.png", dpi = 300,
       width = 10, height = 6)
