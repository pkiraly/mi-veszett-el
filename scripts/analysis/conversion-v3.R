...
types <- cols(
  ...
  `x_s2_peldanyok_letezo` = col_character(),
  `x_s2_peldanyok_letezok_szama_calc` = col_character(),
  `x_s2_peldanyok_letezok_szorodasa_calc` = col_character(),
  ...
  `s2_peldanyok_letezett` = col_character(),
...
write_tsv(df, 'data_raw/rmny-v03.tsv', na = "")
write_tsv(df, 'shiny/rmny/data/rmny-v03.tsv', na = "")

write_rds(df, 'data_raw/rmny-v03.rds')
write_rds(df, 'shiny/rmny/data/rmny-v03.rds')
