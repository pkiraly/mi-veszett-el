...
names <- c(
  ...
  "group5",
  "x_peldanyadatok",
  "x_s1_letezo_peldanyok",
  "x_s1_letezo_peldanyok_szama",
  "x_s1_letezo_peldanyok_szorodasa",
  "x_s1_peldanyok_indikator1",
  "x_s1_peldanyok_indikator2",
  "x_s1_peldanyok_indikator3",
  "x_s1_peldanyok_indikator4",
  "x_s1_peldanyok_indikator0",
  "x_s1_letezett_peldanyok",
  "x_s1_letezett_peldanyok_szama",
  "x_s1_letezett_peldanyok_szorodasa",
  "x_s2_peldanyadatok",
  "x_s2_letezo_peldanyok",
  "x_s2_letezo_peldanyok_szama",
  "x_s2_letezo_peldanyok_szorodasa",
  "x_s2_peldanyok_indikator1",
  "x_s2_peldanyok_indikator2",
  "x_s2_peldanyok_indikator3",
  "x_s2_peldanyok_indikator4",
  "x_s2_peldanyok_indikator0",
  "x_s2_peldanyok_letezett",
  "x_s2_peldanyok_letezett_szama_calc",
  "x_s2_peldanyok_letezett_szorodasa_calc",
  "x_s2_peldanyok_megjegyzes",
  "x_konyvtortenet",
  "x_konyvtorteneti_peldanyok",
  "x_konyvtorteneti_peldanyok_szama",
  "group6",
  "x_peldanyszam_adatforras_jellege",
  "x_hatokor_ter",
  "x_hatokor_ido",
  "x_hatokor_megjegyzes",
  ...
  "x_tamogato_nev",
  "x_tamogatas_mertek",
  "x_tamogatas_adatforras",
  "x_tamogatas_mod",
  "x_tamogato_tarsadalmi_statusz",
  "x_tamogato_tarsadalmi_rang",
  "x_tamogatas_tipus",
  "x_tudashalmaz",
  "empty1",
  "empty2",
...
types <- cols(
  ...
  `x_peldanyadatok` = col_character(),
  `x_s1_letezo_peldanyok` = col_character(),
  `x_s1_letezo_peldanyok_szama` = col_double(),
  `x_s1_letezo_peldanyok_szorodasa` = col_character(),
  `x_s1_peldanyok_indikator1` = col_double(),
  `x_s1_peldanyok_indikator2` = col_double(),
  `x_s1_peldanyok_indikator3` = col_double(),
  `x_s1_peldanyok_indikator4` = col_double(),
  `x_s1_peldanyok_indikator0` = col_double(),
  `x_s1_letezett_peldanyok` = col_character(),
  `x_s1_letezett_peldanyok_szama` = col_double(),
  `x_s1_letezett_peldanyok_szorodasa` = col_character(),
  `x_s2_peldanyadatok` = col_character(),
  `x_s2_letezo_peldanyok` = col_character(),
  `x_s2_letezo_peldanyok_szama` = col_double(),
  `x_s2_letezo_peldanyok_szorodasa` = col_character(),
  `x_s2_peldanyok_indikator1` = col_character(),
  `x_s2_peldanyok_indikator2` = col_character(),
  `x_s2_peldanyok_indikator3` = col_character(),
  `x_s2_peldanyok_indikator4` = col_character(),
  `x_s2_peldanyok_indikator0` = col_character(),
  `x_s2_peldanyok_letezett` = col_character(),
  `x_s2_peldanyok_letezett_szama_calc` = col_character(),
  `x_s2_peldanyok_letezett_szorodasa_calc` = col_character(),
  `x_s2_peldanyok_megjegyzes` = col_character(),
  `x_konyvtortenet` = col_character(),
  `x_konyvtorteneti_peldanyok` = col_character(),
  `x_konyvtorteneti_peldanyok_szama` = col_character(),
  `group6` = col_character(),
  `x_peldanyszam_adatforras_jellege` = col_character(),
  `x_hatokor_ter` = col_character(),
  `x_hatokor_ido` = col_character(),
  `x_hatokor_megjegyzes` = col_character(),
  ...
  `x_tamogato_nev` = col_character(),
  `x_tamogatas_mertek` = col_character(),
  `x_tamogatas_adatforras` = col_character(),
  `x_tamogatas_mod` = col_character(),
  `x_tamogato_tarsadalmi_statusz` = col_character(),
  `x_tamogato_tarsadalmi_rang` = col_character(),
  `x_tamogatas_tipus` = col_character(),
...
# names(df)
# df %>% group_by(`Csoport-Tétel adatok`) %>% count()

tsv_file <- 'data_raw/v04/RMNYStat-data_v04 - RMNYStat-v4.tsv'
...
df <- df %>% 
  select(-c(
    ...
    x_peldanyadatok, x_s2_peldanyadatok, x_konyvtortenet
  )) %>% 
  mutate(
